...
{!! Form::open(array('route' => config('quickadmin.route').'.hargapermeter3air.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}

<div class="form-group">
    {!! Form::label('keterangan', 'Keterangan*', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('keterangan', old('keterangan'), array('class'=>'form-control')) !!}
    ...
    <div class="col-sm-10">
        {!! Form::text('if', old('if'), array('class'=>'form-control')) !!}
